...
// Fast input
MACRO_CONFIG_INT(BcFastInputMode, bc_fast_input_mode, 0, 0, 7, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Fast input mode (0 = fast input, 3 = best input, 4 = saiko+, 5 = snow, 6 = meow, 7 = lexzy; legacy delta/gamma modes map to best input)")
MACRO_CONFIG_INT(BcLexzyFastInputAmount, bc_lexzy_fast_input_amount, 0, 0, 1000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Lexzy input amount in 0.01 ticks")
MACRO_CONFIG_INT(BcLexzyFastInputOthers, bc_lexzy_fast_input_others, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Apply Lexzy input to other tees")
...
// MeowClient
MACRO_CONFIG_INT(MeowChatOffsetX, meow_chat_offset_x, 0, -1000, 1000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Chat X offset")
MACRO_CONFIG_INT(MeowChatOffsetY, meow_chat_offset_y, 0, -1000, 1000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Chat Y offset")
MACRO_CONFIG_INT(MeowScoreHudOffsetX, meow_score_hud_offset_x, 0, -1000, 1000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Score HUD X offset")
MACRO_CONFIG_INT(MeowScoreHudOffsetY, meow_score_hud_offset_y, 0, -1000, 1000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Score HUD Y offset")
MACRO_CONFIG_INT(MeowVoteOffsetX, meow_vote_offset_x, 0, -1000, 1000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Vote X offset")
MACRO_CONFIG_INT(MeowVoteOffsetY, meow_vote_offset_y, 0, -1000, 1000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Vote Y offset")
MACRO_CONFIG_INT(MeowFrozenHudOffsetX, meow_frozen_hud_offset_x, 0, -1000, 1000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Frozen HUD X offset")
MACRO_CONFIG_INT(MeowFrozenHudOffsetY, meow_frozen_hud_offset_y, 0, -1000, 1000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Frozen HUD Y offset")
MACRO_CONFIG_INT(MeowDemoHudOffsetX, meow_demo_hud_offset_x, 0, -1000, 1000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Demo HUD X offset")
MACRO_CONFIG_INT(MeowDemoHudOffsetY, meow_demo_hud_offset_y, 0, -1000, 1000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Demo HUD Y offset")
MACRO_CONFIG_INT(MeowDummyActionsOffsetX, meow_dummy_actions_offset_x, 0, -1000, 1000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Dummy actions X offset")
MACRO_CONFIG_INT(MeowDummyActionsOffsetY, meow_dummy_actions_offset_y, 0, -1000, 1000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Dummy actions Y offset")
MACRO_CONFIG_INT(MeowMovementInfoOffsetX, meow_movement_info_offset_x, 0, -1000, 1000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Movement info X offset")
MACRO_CONFIG_INT(MeowMovementInfoOffsetY, meow_movement_info_offset_y, 0, -1000, 1000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Movement info Y offset")
MACRO_CONFIG_INT(MeowLocalTimeOffsetX, meow_local_time_offset_x, 0, -1000, 1000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Local time X offset")
MACRO_CONFIG_INT(MeowLocalTimeOffsetY, meow_local_time_offset_y, 0, -1000, 1000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Local time Y offset")
MACRO_CONFIG_INT(MeowFpsPredOffsetX, meow_fps_pred_offset_x, 0, -1000, 1000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "FPS pred X offset")
MACRO_CONFIG_INT(MeowFpsPredOffsetY, meow_fps_pred_offset_y, 0, -1000, 1000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "FPS pred Y offset")
MACRO_CONFIG_INT(MeowGoresMode, meow_gores_mode, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable MeowClient gores mode")
MACRO_CONFIG_INT(MeowAutoLockTeam, meow_auto_lock_team, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Auto lock team")
MACRO_CONFIG_INT(MeowAutoLockTeamSeconds, meow_auto_lock_team_seconds, 0, 0, 60, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Auto lock team seconds")
MACRO_CONFIG_INT(MeowShowUserIndicator, meow_show_user_indicator, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show user indicator")
MACRO_CONFIG_INT(MeowUserIndicatorSize, meow_user_indicator_size, 100, 10, 500, CFGFLAG_CLIENT | CFGFLAG_SAVE, "User indicator size")
