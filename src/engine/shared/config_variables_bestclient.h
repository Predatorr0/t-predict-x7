...
MACRO_CONFIG_INT(BcFastInputGammaInput, bc_fast_input_gamma_input, 0, 0, 1200, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Legacy gamma input amount used to migrate old configs")
MACRO_CONFIG_INT(BcFastInputGammaMovement, bc_fast_input_gamma_movement, 0, 0, 600, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Gamma movement amount in 0.01 ticks (UI shows 0-6.00M)")
MACRO_CONFIG_INT(BcFastInputGammaHook, bc_fast_input_gamma_hook, 0, 0, 600, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Gamma hook amount in 0.01 ticks (UI shows 0-6.00M)")
